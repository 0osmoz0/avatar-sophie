...
export function createAllStates(): PetState[] {
  return [
    ...
    new ActivityState("PHONE_CHECK", "phone_check", PRIORITY.PHONE_CHECK, 4, 8),
    new ActivityState("PHONE_TEXT", "phone_text", PRIORITY.PHONE_TEXT, 5, 10),
    new ActivityState("PHONE_CALL", "phone_call", PRIORITY.PHONE_CALL, 6, 12),
    new DanceState(),
